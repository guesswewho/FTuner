...
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_efficient_search.py::test_train_BERT_H768
cp dietcode_autosched_dense_16xTxIx768.json saved_schedules_G4
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_efficient_search.py::test_train_BERT_H3072
