...
# AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_efficient_search.py::test_train_GPT_I768_H50257
# cp dietcode_autosched_dense_16xTx768x50257.json saved_schedules_G4
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_efficient_search.py::test_train_GPT_I3072_H768
cp dietcode_autosched_dense_add_16xTx3072x768.json saved_schedules_G4
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_efficient_search.py::test_train_GPT_I768_H3072
cp dietcode_autosched_dense_add_16xTx768x3072.json saved_schedules_G4
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_efficient_search.py::test_train_GPT_I768_H768
cp dietcode_autosched_dense_add_16xTx768x768.json saved_schedules_G4
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_efficient_search.py::test_train_GPT_I768_H2304
...
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_efficient_search.py::test_train_dynT_2
...
pytest -s test_efficient_search.py::test_infer_dynT
