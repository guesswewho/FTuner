...
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_dietcode.py::test_train_BERT_LARGE_I1024_H4096
cp dietcode_autosched_dense_16xTx1024x4096.json saved_schedules_G4
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_dietcode.py::test_train_BERT_LARGE_I1024_H1024
cp dietcode_autosched_dense_16xTx1024x1024.json saved_schedules_G4
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_dietcode.py::test_train_BERT_LARGE_I4096_H1024
...
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_dietcode.py::test_train_BERT_LARGE_dynT_1
cp dietcode_autosched_batch_matmul_nt_256xTx64xT.json saved_schedules_G4
AUTO_SCHED_NTRIALS=${AUTO_SCHED_NTRIALS} pytest -s test_dietcode.py::test_train_BERT_LARGE_dynT_2
...
pytest -s test_dietcode.py::test_infer_large_dynT
